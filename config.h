...
/* *** This config use QWERTY keyboard layout. *** */
...
static char *fonts[]          = { "Hack:size=15", "NotoColorEmoji:size=14:antialias=true:autohint=true" };
...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,    XK_minus,         spawn,            SHCMD("pulsemixer --change-volume -10; kill -44 $(pidof dwmblocks)") },
  { MODKEY,              XK_equal,         spawn,            SHCMD("pulsemixer --change-volume +3; kill -44 $(pidof dwmblocks)") },
  { MODKEY|ShiftMask,    XK_equal,         spawn,            SHCMD("pulsemixer --change-volume +10; kill -44 $(pidof dwmblocks)") },
  { MODKEY,              XK_BackSpace,     spawn,            SHCMD("sysact") },
  { MODKEY|ShiftMask,    XK_BackSpace,     spawn,            SHCMD("reloadwm") },
 ...
 /*ugly but work */
  ...
  { 0,                   XK_Print,         spawn,            SHCMD("maimall") },
